...
const isRandomDataLoading = ref(false);
const updateRandomData = () => {
  isRandomDataLoading.value = true;
  //Define Constants
  ...
  setTimeout(() => {
    isRandomDataLoading.value = false;
  }, 700);
}
...
<template>
  ...
  <div class="container mx-auto pb-4">
    <div class="text-center justify-center">
      <PrimaryButton @click="updateRandomData" class="my-4" :title="'Click to Generate Unlimited Random Data'">
        Generate Data
        <svg xmlns="http://www.w3.org/2000/svg" :class="['ml-2', { 'animate-spin': isRandomDataLoading }]" width="24"
          height="24"
